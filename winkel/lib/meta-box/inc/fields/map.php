...
class RWMB_Map_Field extends RWMB_Field {
	...
	public static function html( $meta, $field ) {
		...
		$html .= sprintf(
			'<div class="rwmb-map-winkel" data-default-loc="%s" data-region="%s"></div>
		...
		if ( $address ) {
			$html .= sprintf(
				...
				esc_html__( 'Find Address', 'winkel' )
			);
		}
	...
	public static function the_value( $field, $args = array(), $post_id = null ) {
		...
		$output = sprintf(
			'<div class="rwmb-map-winkel" data-map_options="%s" style="width:%s;height:%s"></div>',
