...
class Winkel_Theme_License{
	...
	public function add_license_page(){
        global $submenu;
		add_submenu_page('winkel-options','License', 'License', 'manage_options', 'winkel-theme-license', array($this, 'license_form'));
        $submenu['winkel-options'][] = array( 'Winkel Docs', 'manage_options' , 'https://www.themeum.com/docs/winkel-introduction/');
        $submenu['winkel-options'][] = array( 'Winkel Support Forum', 'manage_options' , 'https://www.themeum.com/forums/forum/winkel/');
	}
	...
	public function check_license_key(){
		if ( ! empty($_POST['thm_check_license_code'])){
			...
			$key  = sanitize_text_field($_POST['winkel_license_key']);
				...
				<div class="themeum-box">
					...
					<form action="" method="post">
						...
						<p style="width: 100%; display: flex; flex-wrap: nowrap; box-sizing: border-box;">
							<input id="winkel_license_key" name="winkel_license_key" size="15" value="" class="regular-text code" style="flex-grow: 1; margin-right: 1rem;" type="text" placeholder="Enter your license key here" />
