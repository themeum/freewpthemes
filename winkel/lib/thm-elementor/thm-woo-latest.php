...
class Themeum_Widget_Woo_Latest_Products extends Widget_Base {

	public function get_name() {
		return 'winkel-latest-product';
	}

	public function get_title() {
		return __( 'Latest Products', 'winkel' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
            'woo_product',
            [
                'label' 	=> __( 'Latest Product', 'winkel' )
            ]
        );
		$this->add_control(
		  'woo_number',
...
Plugin::instance()->widgets_manager->register_widget_type( new Themeum_Widget_Woo_Latest_Products() );