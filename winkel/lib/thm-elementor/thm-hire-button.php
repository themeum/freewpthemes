...
function winkel_hire_contact_form(){
	$contact_forms = array();
...
class Widget_Themeum_Hire_Button extends Widget_Base {
	...
	public function get_title() {
		return __( 'Themeum Hire Button', 'winkel' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'contact_button',
			[
				'label' 		=> __( 'Contact Form', 'winkel' ),
				'type' 			=> Controls_Manager::SELECT,
				'default' 		=> '',
				'options'		=> winkel_hire_contact_form(),
		...
		$this->add_control(
			'hire_button_name',
			[
				'label' 		=> __( 'Button Name', 'winkel' ),
				'type' 			=> Controls_Manager::TEXT,
				'default' 		=> __( 'Hire me', 'winkel' ),
				'placeholder' 	=> __( 'Hire Me', 'winkel' ),
				'dynamic' 		=> [],
			]
		);
		        ...
		        <div class="modal-dialog" role="document">
		            <div class="modal-content">
		                <div class="modal-header">
		                    ...
		                    <h4 class="modal-title"><?php _e( 'Hire for your next project','winkel' ); ?></h4>
