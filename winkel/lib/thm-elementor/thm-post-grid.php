...
class Themeum_Widget_Posts_Grid extends Widget_Base {
	...
	public function get_name() {
		return 'winkel-posts-grid';
	}

	public function get_title() {
		return __( 'Themeum Posts Grid', 'winkel' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .winkel-post .entry-summary' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' 	=> '{{WRAPPER}} .winkel-post .entry-summary',
			]
		);
		...
		<div class="row">
			<?php if ( $data->have_posts() ) : ?>
				...
				<div class="blog-post-item-col col-<?php echo $post_column; ?>">
				    <article class="winkel-post winkel-single-post winkel-index-post">
				        ...
				        <div class="winkel-blog-title clearfix">
				            ...
				            <div class="entry-blog">
				                <div class="entry-summary clearfix">
				                    <?php echo winkel_excerpt_max_charlength( $textlimit ); ?>
				                    <p class="wrap-btn-style"><a class="btn btn-style" href="<?php echo esc_url($permalink); ?>"><?php _e( 'Read More','winkel' ); ?> <i class="fa fa-chevron-right" aria-hidden="true"></i></a></p>
