...
class Widget_Themeum_Gmap extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
            'section_title',
            [
                'label' => __( 'GMap Content', 'winkel' )
            ]
        );
		$this->add_control(
            'gmap_address',
            [
                'label' => __( 'Address', 'winkel' ),
        ...
        $this->add_control(
            'gmap_type',
            [
                'label'     => __( 'Map Type', 'winkel' ),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'hybrid',
                'options'   => [
                        'roadmap' 	=> __( 'Roadmap', 'winkel' ),
                        'satellite' => __( 'Satellite', 'winkel' ),
                        'hybrid' 	=> __( 'Hybrid', 'winkel' ),
                        'terrain' 	=> __( 'Terrain', 'winkel' ),
                    ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default'   => 'style1',
                'options'   => [
                        'style1' 	=> __( 'Map Style 1', 'winkel' ),
                        'style2' 	=> __( 'Map Style 2', 'winkel' ),
                        'style3' 	=> __( 'Map Style 3', 'winkel' ),
                        'style4'    => __( 'Map Style 4', 'winkel' ),
                        'default' 	=> __( 'Map Style Default', 'winkel' ),
                    ],
            ]
        );
        ...
        $this->add_control(
            'gmap_controls',
            [
                'label'     => __( 'Map Controls', 'winkel' ),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'false',
                'options'   => [
                        'true'      => __( 'Map Control Off', 'winkel' ),
                        'false'     => __( 'Map Control On', 'winkel' ),
                    ],
            ]
        );
        ...
        $this->add_control(
            'gmap_zoomcontrol',
            [
                'label'     => __( 'Map Zoom Wheel', 'winkel' ),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'false',
                'options'   => [
                        'false'     => __( 'Zoom Wheel Off', 'winkel' ),
                        'true'      => __( 'Zoom Wheel On', 'winkel' ),
                    ],
            ]
        );
        ...
        $this->add_control(
            'gmap_icon',
            [
                'label'         => __( 'Flug Icon (Optional)', 'winkel' ),
