...
class Widget_Themeum_Team extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
		    'team_headline',
		    [
		        'label'     => __( 'Select the Elements', 'winkel' ),
		        'type'      => Controls_Manager::SELECT,
		        'default'   => 'h3',
		        'options'   => [
		                'h1'  	=> 'H1',
        ...
        $this->add_control(
           	'team_title',
            [
                'label' 		=> __( 'Name', 'winkel' ),
                'type' 			=> Controls_Manager::TEXT,
                'label_block' 	=> true,
                'placeholder' 	=> __( 'Enter Name', 'winkel' ),
                'default' 		=> __( 'Jon Deo', 'winkel' ),
            ]
        );
        ...
        $this->add_control(
           	'team_subtitle',
            [
                'label' 		=> __( 'Designation', 'winkel' ),
                'type' 			=> Controls_Manager::TEXT,
                'label_block' 	=> true,
                'placeholder' 	=> __( 'Enter Designation', 'winkel' ),
                'default' 		=> __( 'Developer', 'winkel' ),
            ]
        );
        $this->add_control(
            'team_desc',
            [
                ...
                'default' 		=> __( 'Write your description content of this section.', 'winkel' ),
            ]
        );         
		...
		$this->add_control(
			'team_social',
			[
				'label' => __( 'Show Social', 'winkel' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'label_on' => __( 'Show', 'winkel' ),
				'label_off' => __( 'Hide', 'winkel' ),
				'return_value' => 'yes',
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'team_google-plus',
			[
				'label' => __( 'Google Plus URL', 'winkel' ),
				'type' => Controls_Manager::URL,
				'placeholder' => __( 'http://your-link.com', 'winkel' ),
				'condition' => [
					'team_social' => 'yes',
		...
		$this->add_control(
			'stayle_1_color',
			[
				'label'		=> __( 'Basic Background Color', 'winkel' ),
		...
		$this->add_control(
			'name_hover_color',
			[
				'label'		=> __( 'Name Hover Color', 'winkel' ),
				'type'		=> Controls_Manager::COLOR,
				'scheme'	=> [
				    'type'	=> Scheme_Color::get_type(),
				    'value' => Scheme_Color::COLOR_1,
