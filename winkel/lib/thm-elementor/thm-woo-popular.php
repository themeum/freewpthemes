...
class Themeum_Widget_Woo_Popular_Products extends Widget_Base {

	public function get_name() {
		return 'winkel-popular-product';
	}

	public function get_title() {
		return __( 'Popular Products', 'winkel' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
            'woo_product',
            [
                'label' 	=> __( 'Popular Product', 'winkel' )
            ]
        );
		$this->add_control(
		  'woo_number',
        ...
        $this->add_control(
          ...
          [
             ...
             'type'     => Controls_Manager::SELECT,
             'options'  => winkel_all_category_list( 'product_cat' ),
             'multiple' => true,
             'default'  => 'allpost',
          ]
        );
...
Plugin::instance()->widgets_manager->register_widget_type( new Themeum_Widget_Woo_Popular_Products() );