...
class Winkel_Woo_Popular{

	public function get_name(){
		return 'winkel_woo_popular';
	}
	public function get_title(){
		return 'Popular Product';
	}
	public function get_icon() {
		return 'wppb-font-shopping-cart';
	}
	...
	public function get_settings() {
		...
		$settings = array(
			...
			'woo_cat' => array(
			    ...
			    'values' => winkel_all_category_list( 'product_cat' ),
			...
			'title_color'=> array(
			    ...
			    'title' => 'Title Color',
			    'std' => '#333',
			    'selector' => '{{SELECTOR}} .thm-product-title a{ color: {{data.title_color}}; }'
			),
			'title_hover_color'=> array(
			    ...
			    'std' => '#fd5238',
			    'selector' => '{{SELECTOR}} .thm-product-title a:hover{ color: {{data.title_hover_color}}; }'
			),
	...
	if( function_exists('WC') ){
		...
		$woo_cat 			= isset($settings['woo_cat']) ? $settings["woo_cat"] : '';
			...
			<?php if ( $data->have_posts() ) : ?>
		        <?php while ( $data->have_posts() ) : $data->the_post(); 
		            ...
		            <div class="col-md-6 col-lg-<?php echo $woo_column['md']; ?> product-item">
						<div class="inner">
							<h4 class="thm-product-title"><a href="<?php the_permalink(); ?>"><?php echo get_the_title(); ?></a></h4>
