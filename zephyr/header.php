      ...
      <div class="container">
          <div class="row">
                      ...
                      <div class="logo-wrapper">
                            <a class="themeum-navbar-brand" href="<?php echo esc_url(site_url()); ?>">
                                <?php
                                  ...
                                  $logotext  = get_theme_mod( 'logo_text', 'zephyr' );
            ...
            <?php } ?>
              ...
              <?php if( ! class_exists('wp_megamenu_initial_setup')) { ?>
                <div class="col-sm-6 col-md-8 col-6 zephyr-menu hidden-lg-up">
              ...
              <?php if( !class_exists('wp_megamenu_initial_setup') ) { ?>
                <div class="col-md-12 col-lg-7 common-menu space-wrap">
              <?php } else { ?>
                <div class="AA col-md-12 col-lg-12 common-menu common-main-menu">
              <?php } ?>
              ...
              <?php if( !class_exists('wp_megamenu_initial_setup') ) { ?>
                <div class="col-md-3 col-lg-3 spache-wrap social">
