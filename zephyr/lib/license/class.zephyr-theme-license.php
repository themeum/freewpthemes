...
class Zephyr_Theme_License{
	...
	public function license_page_asset_enquee(){
		wp_enqueue_style('plugin-license-handler', ZEPHYR_URI.'lib/license/license.css');
	}

	public function add_license_page(){
		global $submenu;
		add_submenu_page('zephyr-options','License', 'License', 'manage_options', 'zephyr-theme-license', array($this, 'license_form'));
		$submenu['zephyr-options'][] = array( 'Zephyr Docs', 'manage_options' , 'https://www.themeum.com/docs/zephyr-introduction/');
		$submenu['zephyr-options'][] = array( 'Zephyr Support Forum', 'manage_options' , 'https://www.themeum.com/forums/forum/zephyr/');
	}
	...
	public function check_license_key(){
		if ( ! empty($_POST['thm_check_license_code'])){
			...
			$key  = sanitize_text_field($_POST['zephyr_blog_license_key']);
				...
				<div class="themeum-box">
					...
					<form action="" method="post">
						...
						<p style="width: 100%; display: flex; flex-wrap: nowrap; box-sizing: border-box;">
							<input id="zephyr_blog_license_key" name="zephyr_blog_license_key" size="15" value="" class="regular-text code" style="flex-grow: 1; margin-right: 1rem;" type="text" placeholder="Enter your license key here" />
