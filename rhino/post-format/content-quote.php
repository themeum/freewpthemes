...
<?php else: ?>
    <article id="post-<?php the_ID(); ?>" <?php post_class('rhino-post rhino-quote rhino-single-post rhino-index-post'); ?>>
<?php endif; ?>

    <div class="featured-wrap-quite">
        <?php if(function_exists('rwmb_meta')){ ?>
            <?php  if ( get_post_meta( get_the_ID(), 'rhino_qoute',true ) ) { ?>
                <div class="entry-quote-post-format">
                    <span class="blog-content-quote"><i class="fa fa-quote-left" aria-hidden="true"></i></span>
                    <blockquote>
                        <h2><?php echo esc_html(get_post_meta( get_the_ID(), 'rhino_qoute',true )); ?></h2>
                        <span>&nbsp; <i class="fa fa-minus" aria-hidden="true"></i> &nbsp;<?php echo esc_html(get_post_meta( get_the_ID(), 'rhino_qoute_author',true )); ?></span>
                    </blockquote>
                </div>
            <?php } ?>
        <?php } ?>
