...
<?php else: ?>
    <article id="post-<?php the_ID(); ?>" <?php post_class('rhino-post rhino-index-post'); ?>>
<?php endif; ?>
    ...
    <?php if ( has_post_thumbnail() ){ ?>
        <div class="blog-details-img">
            <?php if( is_single() ){ ?>
                ...
                <?php the_post_thumbnail('rhino-large', array('class' => 'img-fluid')); ?>
                ...
                <?php 
                    ...
                    if ($col == 3) { ?>
                        <a href="<?php the_permalink(); ?>">
                            <?php the_post_thumbnail('rhino-blog-medium', array('class' => 'img-fluid')); ?>
                        </a> 
                    <?php }elseif ($col == 4) { ?>
                        <a href="<?php the_permalink(); ?>">
                            <?php the_post_thumbnail('rhino-blog-medium', array('class' => 'img-fluid')); ?>
    ...
    <div class="rhino-blog-content clearfix"> 
        <?php
            if (is_single()) { ?>
            ...
            <ul class="blog-post-meta clearfix"> 
                <?php if ( get_theme_mod( 'blog_category_single', true ) ): ?>
                    <li class="meta-category">
                        <?php printf(esc_html__('%s', 'rhino'), get_the_category_list(', ')); ?>
                    </li>
                <?php endif; ?>  
        ...
        <ul class="blog-post-meta post-meta-bottom clearfix">
            ...
            <?php if ( get_theme_mod( 'blog_author_single', true ) ): ?>
                <li class="meta-author">
                    <span class="gocharity-user-1"></span>
        ...
        <?php
            ...
            <ul class="blog-post-meta clearfix"> 
                ...
                <?php if ( get_theme_mod( 'blog_author', false ) ): ?>
                    <li class="meta-author">
                        <i class="fa fa-user"></i> <?php esc_html_e('By', 'rhino') ?> <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php echo get_the_author_meta('display_name'); ?></a>
                    </li>
                <?php endif; ?>
            ...
            <div class="rhino-post-meta">
                <ul>
                    ...
                    <?php if ( get_theme_mod( 'blog_comment', false ) ) { ?>
                            <li><i class="fa fa-comments-o"></i> <?php comments_number( '0', '1', '%' ); echo esc_attr__( ' Comments', 'rhino' ); ?></li>
                    <?php } ?>  
                </ul>
            </div>
        <?php } ?>
