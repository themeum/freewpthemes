...
class Rhino_Theme_License{
	...
	public function license_page_asset_enquee(){
		wp_enqueue_style('plugin-license-handler', RHINO_URI.'lib/license/license.css');
	}

	public function add_license_page(){
		global $submenu;
		add_submenu_page('rhino-options','License', 'License', 'manage_options', 'rhino-theme-license', array($this, 'license_form'));
		$submenu['rhino-options'][] = array( 'Rhino Docs', 'manage_options' , 'https://www.themeum.com/docs/rhino-introduction/');
		$submenu['rhino-options'][] = array( 'Rhino Support Forum', 'manage_options' , 'https://www.themeum.com/forums/forum/rhino/');
	}
	...
	public function check_license_key(){
		if ( ! empty($_POST['thm_check_license_code'])){
			...
			$key  = sanitize_text_field($_POST['rhino_license_key']);
				...
				<div class="themeum-box">
					...
					<form action="" method="post">
						...
						<p style="width: 100%; display: flex; flex-wrap: nowrap; box-sizing: border-box;">
							<input id="rhino_license_key" name="rhino_license_key" size="15" value="" class="regular-text code" style="flex-grow: 1; margin-right: 1rem;" type="text" placeholder="Enter your license key here" />
