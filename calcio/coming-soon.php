...
if ( get_theme_mod('coming_soon_bg_color', '#ef3f48') ) {
    $b_style = 'background: '.get_theme_mod('coming_soon_bg_color', '#ef3f48').';';
}

?>

<div class="comingsoon" style="<?php print $b_style; ?>">
        <div class="comingsoon-wrap text-center">
            <div class="comingsoon-content">
                ...
                <div class="coming-soon-logo">
                    <img src="<?php echo esc_url( get_theme_mod('comingsoon_logo',get_parent_theme_file_uri( 'images/logo.png' ))); ?>" alt="<?php  esc_attr_e( 'Logo', 'calcio' ); ?>">
                </div>
                <?php endif; ?>
                <!-- end -->
                ...
                <div class="counter-class" data-date="<?php echo esc_attr($countdate);?>">
                    <div id="comingsoon-countdown">
                        <div class="countdown-section"><span class="countdown-amount first-item countdown-days counter-days"></span> <span class="countdown-period"><?php esc_html_e('Days', 'calcio') ?></span></div>
                        <div class="countdown-section"><span class="countdown-amount countdown-hours counter-hours"></span> <span class="countdown-period"><?php esc_html_e('Hours', 'calcio') ?></span></div>
                        <div class="countdown-section"><span class="countdown-amount countdown-minutes counter-minutes"></span> <span class="countdown-period"><?php esc_html_e('Minutes', 'calcio') ?></span></div>
                        <div class="countdown-section"><span class="countdown-amount countdown-seconds counter-seconds"></span> <span class="countdown-period"><?php esc_html_e('Seconds', 'calcio') ?></span></div>
                    </div>
                </div>
