...
class Personal_Blog_Theme_License{
	...
	public function add_license_page(){
		add_submenu_page('bridegroom-options','License', 'License', 'manage_options', 'bridegroom-theme-license', array($this, 'license_form'));
	}
	...
	public function check_license_key(){
		if ( ! empty($_POST['thm_check_license_code'])){
			...
			$key  = sanitize_text_field($_POST['bridegroom_blog_license_key']);
				...
				<div class="themeum-box">
					...
					<form action="" method="post">
						...
						<p style="width: 100%; display: flex; flex-wrap: nowrap; box-sizing: border-box;">
							<input id="bridegroom_blog_license_key" name="bridegroom_blog_license_key" size="15" value="" class="regular-text code" style="flex-grow: 1; margin-right: 1rem;" type="text" placeholder="Enter your license key here" />
