<?php get_header(); ?>
    ...
    <?php $disable_subheader = get_post_meta( get_the_ID(), 'themeum_disable_subheader', false ); ?>
    ...
    <section id="main" class="page-content">
        <div class="container">
            <div class="row">
                ...
                <?php
                    $s_col = '12';
                    if(get_theme_mod('blog_single_sidebar', false)) {
                        $s_col = '8';
                    }
                ?>
                    ...
                    <?php if ( have_posts() ) :  ?>
                        <?php while ( have_posts() ) : the_post(); ?>
                            ...
                            <?php if(get_theme_mod('blog_single_author', false)):  ?>
                                <div class="bridegroom-single-post-author clearfix">
                                    <?php echo get_avatar( $post, 60 ); ?>
                                    <div class="bridegroom-author-meta-data">
                            ...
                            <div class="entry-content entry-content-page  clearfix">
                                <?php
                                    wp_link_pages( array(
                                        'before'      => '<div class="page-links"><span class="page-links-title">' . esc_html__( 'Pages:', 'bridegroom' ) . '</span>',
                                        'after'       => '</div>',
                                        'link_before' => '<span>',
                                        'link_after'  => '</span>',
                                    ) ); 
                ...
                <?php if(get_theme_mod('blog_single_sidebar', false)) {
                    get_sidebar( );
                }  ?>
