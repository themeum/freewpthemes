...
if(!function_exists('melody_setup')):
    function melody_setup(){
        ...
        add_image_size( 'melody-pagination', 650, 120, true );
        add_image_size( 'melody-gallery', 640, 400, true );
        add_image_size( 'melody-slider', 442, 390, true );
        add_image_size( 'melody-latest-post', 76, 76, true ); # Latest Post
        add_image_size( 'melody-slider', 478, 534, true ); 
        add_image_size( 'melody-feed', 240, 240, true ); # News Feed
...
*              Themeum Pagination
*-------------------------------------------------------*/
if(!function_exists('melody_pagination')):

    function melody_pagination( $page_numb , $max_page ){
        $big = 999999999;
...
if(!function_exists('melody_css_generator')){
    function melody_css_generator(){
        ...
        if($header_bgc){
            ...
            $output .= '.site-header{ background-color: '.esc_attr( get_theme_mod( 'header_color', '#111111' ) ) .'; }';
        }
        ...
        if($body_bgc){
            ...
            $output .= 'body{ background-color: '.esc_attr( get_theme_mod( 'body_bg_color', '#f9f9f9' ) ) .'; }';
        }
...
.site-header .common-menu-wrap .custom-nav>li .sub-menu li a:hover{ color: '.esc_attr( get_theme_mod( 'sub_menu_text_color_hover', '#FF0078' ) ) .';}';
        ...
        //footer
        $output .= '#footer-wrap{ background-color: '.esc_attr( get_theme_mod( 'copyright_bg_color', '#111111' ) ) .'; }';
