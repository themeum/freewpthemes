            ...
            <?php if(function_exists('rwmb_meta')){ ?>
                <?php  if ( get_post_meta( get_the_ID(), 'qoute',true ) ) { ?>
                    <div class="entry-quote-post-format">
                        ...
                        <blockquote>
                            <h2><?php echo esc_html(get_post_meta( get_the_ID(), 'qoute',true )); ?></h2>
                            <span>&nbsp; <i class="fa fa-minus" aria-hidden="true"></i> &nbsp;<?php echo esc_html(get_post_meta( get_the_ID(), 'qoute_author',true )); ?></span>
                        </blockquote>
                    </div>
                <?php } ?>
            <?php } ?>
