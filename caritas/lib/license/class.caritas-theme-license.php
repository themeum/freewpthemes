...
class Caritas_Theme_License{
	...
	public function license_page_asset_enquee(){
		wp_enqueue_style('plugin-license-handler', CARITAS_URI.'lib/license/license.css');
	}

	public function add_license_page(){
		global $submenu;
		add_submenu_page('caritas-options','License', 'License', 'manage_options', 'caritas-theme-license', array($this, 'license_form'));
		$submenu['caritas-options'][] = array( 'Caritas Docs', 'manage_options' , 'https://www.themeum.com/docs/caritas-introduction/');
		$submenu['caritas-options'][] = array( 'Caritas Support Forum', 'manage_options' , 'https://www.themeum.com/forums/forum/caritas/');
	}
	...
	public function check_license_key(){
		if ( ! empty($_POST['thm_check_license_code'])){
			...
			$key  = sanitize_text_field($_POST['caritas_license_key']);
				...
				<div class="themeum-box">
					...
					<form action="" method="post">
						...
						<p style="width: 100%; display: flex; flex-wrap: nowrap; box-sizing: border-box;">
							<input id="caritas_license_key" name="caritas_license_key" size="15" value="" class="regular-text code" style="flex-grow: 1; margin-right: 1rem;" type="text" placeholder="Enter your license key here" />
