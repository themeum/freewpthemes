                ...
                'params'      => array(
                    'Title' => array(
                          array(
                                'name'        => 'latitude',
                                'type'        => 'text',
                                'label'       => esc_html__( 'Latitude', 'starterpro' ),
                                'admin_label' => true,
                            ),
                          array(
                                'name'        => 'longitude',
                          ...
                          array(
                                ...
                                'value'       => '670px',
                                'description' => esc_html__( 'Choose the height of the google Map.', 'starterpro' ),
                            ),
                        array(
                            'name'        => 'address',
                            'type'        => 'textarea',
                            'label'       => 'Address' ,
                            'description' => esc_html__( 'Address Line of Google Map.', 'starterpro' ),
                        ),
                        ),
                            ...
                            array(
                                ...
                                'options'   => array(
                                    array(
                                        ...
                                        'Popup Image'  => array(
                                            array('property' => 'background-color', 'label' => esc_html__('Background Color', 'starterpro'), 'selector' => '.map-address'),
                                            array('property' => 'color', 'label' => esc_html__('Address Label Color', 'starterpro'), 'selector' => '.map-address strong'),
                                            array('property' => 'background-color', 'label' => esc_html__('Address Label Border Color', 'starterpro'), 'selector' => '.map-address strong::after'),
                                            array('property' => 'color', 'label' => esc_html__('Address Text Color', 'starterpro'), 'selector' => '.map-address'),
                                        ),                               
                                    )
                                )
                            )
