	...
	class THMC_Framework
	{
		...
		public function customizer_scripts()
		{
			...
			wp_localize_script( 'thmc-customizer', 'thm_customizer', array(
				...
				'import_success' => esc_html__('Success! Your theme data successfully imported. Page will be reloaded within 2 sec.', 'starterpro'),
				'import_error' => esc_html__('Error! Your theme data importing failed.', 'starterpro'),
				'file_error' => esc_html__('Error! Please upload a file.', 'starterpro')
			) );
		}
...
class THM_Customize
{
	...
	public function import_export_ui( $wp_customize )
	{
		...
		$wp_customize->add_section( 'thm_import_export', array(
			'title'           => esc_html__( 'Import/Export', 'starterpro' ),
			'description'     => esc_html__( 'Import Export Option Data', 'starterpro' ),
			'priority'        => 1000,
		) );
