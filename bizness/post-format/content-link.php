...
<?php endif; ?>
    ...
    <div class="content-link-content bizness-blog-title clearfix">
         ...
         <?php
            ...
            <ul class="blog-post-meta clearfix">
                ...
                <?php if ( get_theme_mod( 'blog_author', false ) ): ?>
                    <li class="meta-author">
                        <?php esc_html_e('by', 'bizness') ?> <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php echo get_the_author_meta('display_name'); ?></a>
                    </li>
                <?php endif; ?>
