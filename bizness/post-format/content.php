        ...
        <?php
            ...
            <ul class="blog-post-meta clearfix"> 
                ...
                <?php if ( get_theme_mod( 'blog_category', true ) ): ?>
                    <li class="meta-category">
                        <?php printf(esc_html__('%s', 'bizness'), get_the_category_list(', ')); ?>
                    </li>
                <?php endif; ?>
            ...
            <div class="bizness-post-meta">
                <ul>
                    ...
                    <?php if ( get_theme_mod( 'blog_comment', false ) ) { ?>
                            <li><i class="fa fa-comments-o"></i> <?php comments_number( '0', '1', '%' ); echo esc_attr__( ' Comments', 'bizness' ); ?></li>
                    <?php } ?>  
                </ul>
            </div>
        <?php } ?>
