...
class Eventco_Theme_License{
	...
	public function add_license_page(){
		global $submenu;
		add_submenu_page('eventco-options','License', 'License', 'manage_options', 'eventco-theme-license', array($this, 'license_form'));
		$submenu['eventco-options'][] = array( 'Eventco Docs', 'manage_options' , 'https://www.themeum.com/docs/eventco-introduction/');
		$submenu['eventco-options'][] = array( 'Eventco Support Forum', 'manage_options' , 'https://www.themeum.com/forums/forum/eventco/');
	}
	...
	public function check_license_key(){
		if ( ! empty($_POST['thm_check_license_code'])){
			...
			$key  = sanitize_text_field($_POST['eventco_blog_license_key']);
				...
				<div class="themeum-box">
					...
					<form action="" method="post">
						...
						<p style="width: 100%; display: flex; flex-wrap: nowrap; box-sizing: border-box;">
							<input id="eventco_blog_license_key" name="eventco_blog_license_key" size="15" value="" class="regular-text code" style="flex-grow: 1; margin-right: 1rem;" type="text" placeholder="Enter your license key here" />
