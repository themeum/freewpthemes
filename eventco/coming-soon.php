        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="comingsoon-title">
                    <?php echo esc_html(get_theme_mod( 'comingsoontitle', esc_html__('We Are Coming Soon', 'eventco') )); ?>     
                </div>
                <div class="comingsoon-newslatter-descrip">
                    <?php echo get_theme_mod( 'coming_description', esc_html__('We are come back soon', 'eventco') ); ?>
                </div>
                ...
                <div class="counter-class" data-date="<?php echo esc_attr($countdate);?>">
                    <div id="comingsoon-countdown">
                        <div class="countdown-section"><span class="countdown-amount first-item countdown-days counter-days"></span> <span class="countdown-period"><?php esc_html_e('Days', 'eventco') ?></span></div>
                        <div class="countdown-section"><span class="countdown-amount countdown-hours counter-hours"></span> <span class="countdown-period"><?php esc_html_e('Hours', 'eventco') ?></span></div>
                        <div class="countdown-section"><span class="countdown-amount countdown-minutes counter-minutes"></span> <span class="countdown-period"><?php esc_html_e('Min', 'eventco') ?></span></div>
                        <div class="countdown-section"><span class="countdown-amount countdown-seconds counter-seconds"></span> <span class="countdown-period"><?php esc_html_e('Secs', 'eventco') ?></span></div>
                    </div>
                </div>
                ...
                <div class="social-share">
                    <ul>
                        <li><?php esc_html_e('Follow Us: ', 'eventco'); ?></li>
