...
<div class="starterpro-social-share">
	<ul>
		<li>
			<a href="#" data-type="facebook" data-url="<?php echo esc_url($permalink); ?>" data-title="<?php echo $titleget ?>" data-description="<?php echo $titleget ?>" data-media="<?php echo esc_url( $media_url ); ?>" class="prettySocial fa fa-facebook"><?php _e('','personalblog');?></a>
		</li>

		<li>
			<a href="#" data-type="twitter" data-url="<?php echo esc_url($permalink); ?>" data-description="<?php echo $titleget ?>" data-via="<?php echo $themeum_options['twitter-username']; ?>" class="prettySocial fa fa-twitter"> <?php _e('','personalblog');?></a>
		</li>
