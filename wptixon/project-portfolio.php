            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="portfolio-info">
                        <h3 class="style-title2"><span class="span-title2"><?php esc_html_e('Description', 'wptixon')?></span></h3>
                ...
                <div class="col-sm-4">
                    <div class="portfolio-details">
                        <h3 class="style-title2"><span class="span-title2"><?php esc_html_e('Project Details', 'wptixon')?></span></h3>

                        <div class="list list-star">
                            <ul>
                                <?php if($portfolio_client != ''){?>
                                <li><strong><?php esc_html_e('Project Name : ','wptixon'); ?></strong><?php echo esc_html($portfolio_client); ?></li>
                                <?php } ?>                          

                                <?php if($portfolio_date != ''){?>
                                <li><strong><?php esc_html_e('Date : ','wptixon'); ?></strong><?php echo esc_html($portfolio_date); ?></li>
                                <?php } ?>                        

                                <?php if($portfolio_url != ''){?>
                                <li><strong><?php esc_html_e('Category : ' ,'wptixon'); ?></strong><?php echo esc_html($term_name); ?></li>
                                <?php } ?>
                            </ul>
                        </div>
                             
                        <?php if($portfolio_url != ''){?>
                         <a href="<?php echo esc_url($portfolio_url); ?>" target="_blank" class="btn btn-common btn-previw"><?php esc_html_e('Preview','wptixon'); ?> <i class="fa fa-long-arrow-right"></i></a>
                         <?php } ?>  
                    </div>  
                </div>
            </div>
