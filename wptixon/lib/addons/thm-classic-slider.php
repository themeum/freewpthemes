            ...
            'classic_slider' => array(
                ...
                'params'      => array(
                    ...
                    'general' => array(
                        array(
                            'type'          => 'radio_image',
                            'label'         => __( 'Select layout', 'wptixon' ),
                            'name'          => 'layout',
                            'admin_label'   => true,
                            'options'       => array(
                        ...
                        array(
                            ...
                            'params' => array( 
                                ...
                                array(
                                    'type' => 'textarea',
                                    'label' => esc_html__( 'Intro Text', 'wptixon' ),
                                    'name' => 'introtext',
                                    'description' => esc_html__( 'Enter text used as sub title of the slide.', 'wptixon' ),
                                    'admin_label' => false,
                                ),  
                                array(
                                    ...
                                    'value'              => 'fadeIn',
                                    'description'        => esc_html__('Select the intro text animation', 'wptixon'),
                        ...
                        array(
                            ...
                            'options'   => array(
                                array(
                                    ...
                                    'Title' => array(
                                        array('property' => 'color', 'label' => esc_html__('Color', 'wptixon'), 'selector' => '.classic-slider-title'),
                                        array('property' => 'font-family', 'label' => esc_html__('Font Family', 'wptixon'), 'selector' => '.classic-slider-title'),
                                        array('property' => 'font-size', 'label' => esc_html__('Font Size', 'wptixon'), 'selector' => '.classic-slider-title'),
                                        array('property' => 'line-height', 'label' => esc_html__('Line Height', 'wptixon'), 'selector' => '.classic-slider-title'),
                                        array('property' => 'letter-spacing', 'label' => esc_html__('Letter Spacing', 'wptixon'), 'selector' => '.classic-slider-title'),
                                        array('property' => 'font-weight', 'label' => esc_html__('Font Weight', 'wptixon'), 'selector' => '.classic-slider-title'),
                                        array('property' => 'text-transform', 'label' => esc_html__('Text Transform', 'wptixon'), 'selector' => '.classic-slider-title'),
                                        array('property' => 'letter-spacing', 'label' => esc_html__('Letter Spacing', 'wptixon'), 'selector' => '.classic-slider-title'),
                                        array('property' => 'background-color', 'label' => esc_html__('BG Color', 'wptixon'), 'selector' => '.classic-slider-title'),
                                        array('property' => 'margin', 'label' => esc_html__('Margin', 'wptixon'), 'selector' => '.classic-slider-title'),
                                        array('property' => 'padding', 'label' => esc_html__('Padding', 'wptixon'), 'selector' => '.classic-slider-title'),
                                    ),
                                    'Subtitle'  => array(
                                        array('property' => 'color', 'label' => esc_html__('Color', 'wptixon'), 'selector' => '.classic-slider-subtitle'),
                                        array('property' => 'font-family', 'label' => esc_html__('Font Family', 'wptixon'), 'selector' => '.classic-slider-subtitle'),
                                        array('property' => 'font-size', 'label' => esc_html__('Font Size', 'wptixon'), 'selector' => '.classic-slider-subtitle'),
                                        array('property' => 'line-height', 'label' => esc_html__('Line Height', 'wptixon'), 'selector' => '.classic-slider-subtitle'),
                                        array('property' => 'letter-spacing', 'label' => esc_html__('Letter Spacing', 'wptixon'), 'selector' => '.classic-slider-subtitle'),
                                        array('property' => 'font-weight', 'label' => esc_html__('Font Weight', 'wptixon'), 'selector' => '.classic-slider-subtitle'),
                                        array('property' => 'text-transform', 'label' => esc_html__('Text Transform', 'wptixon'), 'selector' => '.classic-slider-subtitle'),
                                        array('property' => 'letter-spacing', 'label' => esc_html__('Letter Spacing', 'wptixon'), 'selector' => '.classic-slider-subtitle'),
                                        array('property' => 'background-color', 'label' => esc_html__('BG Color', 'wptixon'), 'selector' => '.classic-slider-subtitle'),
                                        array('property' => 'margin', 'label' => esc_html__('Margin', 'wptixon'), 'selector' => '.classic-slider-subtitle'),
                                        array('property' => 'padding', 'label' => esc_html__('Padding', 'wptixon'), 'selector' => '.classic-slider-subtitle'),
                                    ),                                     
                                    'Intro text'  => array(
                                        array('property' => 'color', 'label' => esc_html__('Color', 'wptixon'), 'selector' => '.classic-slider-introtext'),
                                        array('property' => 'font-family', 'label' => esc_html__('Font Family', 'wptixon'), 'selector' => '.classic-slider-introtext'),
                                        array('property' => 'font-size', 'label' => esc_html__('Font Size', 'wptixon'), 'selector' => '.classic-slider-introtext'),
                                        array('property' => 'line-height', 'label' => esc_html__('Line Height', 'wptixon'), 'selector' => '.classic-slider-introtext'),
                                        array('property' => 'letter-spacing', 'label' => esc_html__('Letter Spacing', 'wptixon'), 'selector' => '.classic-slider-introtext'),
                                        array('property' => 'font-weight', 'label' => esc_html__('Font Weight', 'wptixon'), 'selector' => '.classic-slider-introtext'),
                                        array('property' => 'text-transform', 'label' => esc_html__('Text Transform', 'wptixon'), 'selector' => '.classic-slider-introtext'),
                                        array('property' => 'letter-spacing', 'label' => esc_html__('Letter Spacing', 'wptixon'), 'selector' => '.classic-slider-introtext'),
                                        array('property' => 'margin', 'label' => esc_html__('Margin', 'wptixon'), 'selector' => '.classic-slider-introtext'),
                                        array('property' => 'padding', 'label' => esc_html__('Padding', 'wptixon'), 'selector' => '.classic-slider-introtext'),
                                    ),                               
                                    'Button' => array(
                                        array('property' => 'color', 'label' => esc_html__('Color', 'wptixon'), 'selector' => '.classic-slider-btn'),
                                        array('property' => 'color', 'label' => esc_html__('Hover Color', 'wptixon'), 'selector' => '.classic-slider-btn:hover'),
                                        array('property' => 'background-color', 'label' => esc_html__('BG Color', 'wptixon'), 'selector' => '.classic-slider-btn'),
                                        array('property' => 'background-color', 'label' => esc_html__('BG Hover Color', 'wptixon'), 'selector' => '.classic-slider-btn:hover'),
                                        array('property' => 'font-family', 'label' => esc_html__('Font Family', 'wptixon'), 'selector' => '.classic-slider-btn'),
                                        array('property' => 'letter-spacing', 'label' => esc_html__('Letter Spacing', 'wptixon'), 'selector' => '.classic-slider-btn'),
                                        array('property' => 'font-size', 'label' => esc_html__('Font Size', 'wptixon'), 'selector' => '.classic-slider-btn'),
                                        array('property' => 'line-height', 'label' => esc_html__('Line Height', 'wptixon'), 'selector' => '.classic-slider-btn'),
                                        array('property' => 'font-weight', 'label' => esc_html__('Font Weight', 'wptixon'), 'selector' => '.classic-slider-btn'),
                                        array('property' => 'text-transform', 'label' => esc_html__('Text Transform', 'wptixon'), 'selector' => '.classic-slider-btn'),
                                        array('property' => 'border', 'label' => esc_html__('Border', 'wptixon'), 'selector' => '.classic-slider-btn'),
                                        array('property' => 'border-color', 'label' => esc_html__('Border Hover Color', 'wptixon'), 'selector' => '.classic-slider-btn:hover'),
                                        array('property' => 'border-radius', 'label' => esc_html__('Border Radius', 'wptixon'), 'selector' => '.classic-slider-btn'),
                                        array('property' => 'margin', 'label' => esc_html__('Margin', 'wptixon'), 'selector' => '.classic-slider-btn'),
                                        array('property' => 'padding', 'label' => esc_html__('Padding', 'wptixon'), 'selector' => '.classic-slider-btn'),
                                    ),
                                    'Box' => array(
                                        array('property' => 'background-color', 'label' => esc_html__('Background Color', 'wptixon'), 'selector' => '.classic-slider-content-in .container >div'),
                                        array('property' => 'background-color', 'label' => esc_html__('Background Hover Color', 'wptixon'), 'selector' => '.classic-slider-content-in .container:hover >div'),
                                        array('property' => 'color', 'label' => esc_html__('Content Color', 'wptixon'), 'selector' => '.classic-slider-content-in .container >div'),
                                        array('property' => 'margin', 'label' => esc_html__('Margin', 'wptixon'), 'selector' => '.classic-slider-content-in .container >div'),
                                        array('property' => 'padding', 'label' => esc_html__('Padding', 'wptixon'), 'selector' => '.classic-slider-content-in .container >div'),
                                    ),
                                )
                            )
                        )
