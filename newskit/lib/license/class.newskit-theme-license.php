...
class Newskit_Theme_License{
	...
	public function license_page_asset_enquee(){
		wp_enqueue_style('plugin-license-handler', NEWSKIT_URI.'lib/license/license.css');
	}

    public function add_license_page(){
        global $submenu;
        /* Newskit docs and support URL */
        add_submenu_page('newskit-options','License', 'License', 'manage_options', 'newskit-theme-license', array($this, 'license_form'));
        $submenu['newskit-options'][] = array( 'Newskit Docs', 'manage_options' , 'https://www.themeum.com/docs/newskit-introduction/');
        $submenu['newskit-options'][] = array( 'Newskit Support Forum', 'manage_options' , 'https://www.themeum.com/forums/forum/newskit/');
    }
	...
	public function check_license_key(){
		if ( ! empty($_POST['thm_check_license_code'])){
			...
			$key  = sanitize_text_field($_POST['newskit_license_key']);
				...
				<div class="themeum-box">
					...
					<form action="" method="post">
						...
						<p style="width: 100%; display: flex; flex-wrap: nowrap; box-sizing: border-box;">
							<input id="newskit_license_key" name="newskit_license_key" size="15" value="" class="regular-text code" style="flex-grow: 1; margin-right: 1rem;" type="text" placeholder="Enter your license key here" />
