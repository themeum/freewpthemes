...
<section class="container comingsoon" style="background-image: url(<?php echo esc_url( get_theme_mod('comingsoonbg',get_template_directory_uri().'/images/coming-soon.png')); ?>);">
    <div class="container" >
        <div class="comingsoon-content">
            <div class="row">
                <div class="col-sm-12" id="comingsoon-soonpage-wrapper">
                    ...
                    <h2 class="comingsoon-title"><?php  echo esc_html(get_theme_mod( 'comingsoontitle', esc_html__('Coming Soon.', 'aresmurphy') )); ?></h2>

                    <div class="counter-class" data-date="'<?php echo esc_attr($countdate);?>">
                        <div id="comingsoon-countdown">
                            <div class="countdown-section"><span class="countdown-amount first-item countdown-days counter-days"></span> <span class="countdown-period"><?php esc_html_e('Days', 'aresmurphy') ?></span></div>
                            <div class="countdown-section"><span class="countdown-amount countdown-hours counter-hours"></span> <span class="countdown-period"><?php esc_html_e('Hours', 'aresmurphy') ?></span></div>
                            <div class="countdown-section"><span class="countdown-amount countdown-minutes counter-minutes"></span> <span class="countdown-period"><?php esc_html_e('Minutes', 'aresmurphy') ?></span></div>
                            <div class="countdown-section"><span class="countdown-amount countdown-seconds counter-seconds"></span> <span class="countdown-period"><?php esc_html_e('Seconds', 'aresmurphy') ?></span></div>
                        </div>
                    </div>
                    ...
                    <?php if ( get_theme_mod( 'copyright_text', true ) ) { ?>
                        <div class="comingsoon-footer-copyright">  
                            <?php if( get_theme_mod( 'copyright_text', true ) ) { ?>
                                <?php echo wp_kses_post(balanceTags( get_theme_mod( 'copyright_text', '© 2017 Ares Murphy. All Rights Reserved.') )); ?>
                            <?php } ?>
                        </div> <!-- end row -->
                    <?php } ?>
                </div> <!-- col-sm-12 -->
