    ...
    <div class="container">
        <div id="portfolio-details" >
            <div class="row">
                ...
                {
                    $thumb = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'aresmurphy-portfo');
                ?>
                <div class="col-sm-12">
                ...
                <div class="col-sm-8">
                    <div class="portfolio-info">
                        <h3 class="style-title2"><span class="span-title2"><?php esc_html_e('Description', 'aresmurphy')?></span></h3>
                ...
                <div class="col-sm-4">
                    <div class="portfolio-details">
                        <h3 class="style-title2"><span class="span-title2"><?php esc_html_e('Project Details', 'aresmurphy')?></span></h3>

                        <div class="list list-star">
                            <ul>
                                <?php if($portfolio_client != ''){?>
                                <li><strong><?php esc_html_e('Project Name : ','aresmurphy'); ?></strong><?php echo esc_html($portfolio_client); ?></li>
                                <?php } ?>                          

                                <?php if($portfolio_date != ''){?>
                                <li><strong><?php esc_html_e('Date : ','aresmurphy'); ?></strong><?php echo esc_html($portfolio_date); ?></li>
                                <?php } ?>                        

                                <?php if($portfolio_url != ''){?>
                                <li><strong><?php esc_html_e('Category : ' ,'aresmurphy'); ?></strong><?php echo esc_html($term_name); ?></li>
                                <?php } ?>
                            </ul>
                        </div>
                             
                        <?php if($portfolio_url != ''){?>
                         <a href="<?php echo esc_url($portfolio_url); ?>" target="_blank" class="btn btn-common btn-previw"><?php esc_html_e('Preview','aresmurphy'); ?> <i class="fa fa-long-arrow-right"></i></a>
                         <?php } ?>  
                    </div>  
                </div>
            </div>
