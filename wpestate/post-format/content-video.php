...
<?php endif; ?>
    ...
    <?php if(function_exists('rwmb_meta')){ ?>
        <?php  if ( get_post_meta( $post->ID, 'wpestate_video',true ) ) { ?>
            <div class="entry-video embed-responsive embed-responsive-16by9">
                <?php $video_source = esc_attr(get_post_meta( $post->ID, 'wpestate_video_source',true )); ?>
                <?php $video = get_post_meta( $post->ID, 'wpestate_video',true ); ?>
                <?php if($video_source == 1): ?>
                    <?php echo get_post_meta( $post->ID, 'wpestate_video',true ); ?>
