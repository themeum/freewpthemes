...
<?php endif; ?>
    ...
    <div class="featured-wrap-link">
        <?php if(function_exists('rwmb_meta')){ ?>
            <?php  if ( get_post_meta( $post->ID, 'wpestate_link',true ) ) { ?>
            <div class="entry-link-post-format">
                <h4><?php echo esc_url( get_post_meta( $post->ID, 'wpestate_link',true ) ); ?></h4>
            </div>
            <?php } ?>
        <?php } ?>
    </div>
    
    <div class="content-link-content wpestate-blog-content clearfix">
         ...
         <?php
            ...
            <ul class="blog-post-meta clearfix">
                ...
                <?php if ( get_theme_mod( 'blog_author', false ) ): ?>
                    <li class="meta-author">
                        <?php esc_html_e('by', 'wpestate') ?> <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php echo get_the_author_meta('display_name'); ?></a>
                    </li>
                <?php endif; ?>
