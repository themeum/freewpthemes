...
class Floox_Theme_License{
	...
	public function license_page_asset_enquee(){
		wp_enqueue_style('plugin-license-handler', FLOOX_URI.'lib/license/license.css');
	}

	public function add_license_page(){
        global $submenu;
		add_submenu_page('floox-options','License', 'License', 'manage_options', 'floox-theme-license', array($this, 'license_form'));
        $submenu['floox-options'][] = array( 'Floox Docs', 'manage_options' , 'https://www.themeum.com/docs/floox-introduction/');
        $submenu['floox-options'][] = array( 'Floox Support Forum', 'manage_options' , 'https://www.themeum.com/forums/forum/floox/');
	}
	...
	public function check_license_key(){
		if ( ! empty($_POST['thm_check_license_code'])){
			...
			$key  = sanitize_text_field($_POST['floox_license_key']);
				...
				<div class="themeum-box">
					...
					<form action="" method="post">
						...
						<p style="width: 100%; display: flex; flex-wrap: nowrap; box-sizing: border-box;">
							<input id="floox_license_key" name="floox_license_key" size="15" value="" class="regular-text code" style="flex-grow: 1; margin-right: 1rem;" type="text" placeholder="Enter your license key here" />
