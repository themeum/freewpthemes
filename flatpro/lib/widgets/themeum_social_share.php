...
class Themeum_social_share_Widget extends WP_Widget{
	...
	public function __construct() {
		parent::__construct( 'Themeum_social_share_Widget', esc_html__("Flat Pro Social Share Widgets",'flatpro'), array('description' => esc_html__("This Social Share Widgets",'flatpro')) );
	}
...
*-------------------------------------------------------*/
	...
	public function form( $instance )
	{
	   ...
	   ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e('Title :', 'flatpro'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'facebook_url' ); ?>"><?php esc_html_e('Facebook URL: ', 'flatpro'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'twitter_url' ); ?>"><?php esc_html_e('Twitter URL: ', 'flatpro'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'gplus_url' ); ?>"><?php esc_html_e('Google Plus URL: ', 'flatpro'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'linkedin_url' ); ?>"><?php esc_html_e('Linkedin URL: ', 'flatpro'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'rss_url' ); ?>"><?php esc_html_e('RSS URL: ', 'flatpro'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'pinterest_url' ); ?>"><?php esc_html_e('Pinterest URL: ', 'flatpro'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'youtube_url' ); ?>"><?php esc_html_e('Youtube URL: ', 'flatpro'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'instagram_url' ); ?>"><?php esc_html_e('Instagram URL: ', 'flatpro'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'vimeo_url' ); ?>"><?php esc_html_e('Vimeo URL: ', 'flatpro'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'dribble_url' ); ?>"><?php esc_html_e('Dribble URL: ', 'flatpro'); ?></label>
