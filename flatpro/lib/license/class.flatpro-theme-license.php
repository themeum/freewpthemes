...
class FlatPro_License{
	...
	public function license_page_asset_enquee(){
		wp_enqueue_style('plugin-license-handler', FLATPRO_URI.'lib/license/license.css');
	}

	public function add_license_page(){
		global $submenu;
		add_submenu_page('flatpro-options','License', 'License', 'manage_options', 'flatpro-theme-license', array($this, 'license_form'));
		$submenu['flatpro-options'][] = array( 'FlatPro Docs', 'manage_options' , 'https://www.themeum.com/docs/flat-theme-pro-introduction/');
		$submenu['flatpro-options'][] = array( 'FlatPro Support Forum', 'manage_options' , 'https://www.themeum.com/flat/');
	}
