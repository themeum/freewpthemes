...
class Themeum_Widget_Counter extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Themeum Counter', 'flatpro' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'counter_digit',
            [
                'label'         => __( 'Digit Number', 'flatpro' ),
                'type'          => Controls_Manager::NUMBER,
                'label_block'   => true,
                'default'       => __( '60', 'flatpro' ),
            ]
        );
        $this->add_control(
            'currency_symbol',
            [
                'label'         => __( 'Prefix Text', 'flatpro' ),
        ...
        $this->start_controls_section(
            'section_style',
            [
                'label'     => __( 'Section Style', 'flatpro' ),
        ...
        $this->add_responsive_control(
            'section_padding',
            [
                'label' => __( 'Section Padding', 'flatpro' ),
        ...
        $this->add_responsive_control(
            'text_padding',
            [
                'label' => __( 'Counter Padding', 'flatpro' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
        ...
        $this->add_responsive_control(
            'text_margin',
            [
                'label' => __( 'Counter Margin', 'flatpro' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
