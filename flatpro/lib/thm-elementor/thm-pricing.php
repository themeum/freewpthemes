...
class Widget_Pricing_table extends Widget_Base {
	...
	public function get_title() {
		return __( 'Themeum Pricing Table', 'flatpro' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_icon',
			[
				'label' => __( 'Pricing Table', 'flatpro' ),
			]
		);
		$this->add_control(
			'layout',
		...
		$this->add_control(
			'price',
			[
				'label' 		=> __( 'Price', 'flatpro' ),
				'type' 			=> Controls_Manager::TEXT,
				'default'		=> '',
				'placeholder' 	=> __( '$25', 'flatpro' ),
			]
		);
		$this->add_control(
			'duration',
			[
				'label' 		=> __( 'Duration', 'flatpro' ),
				'type' 			=> Controls_Manager::TEXT,
				'default'		=> '',
				'placeholder' 	=> __( '1 Month', 'flatpro' ),
			]
		);
		$this->add_control(
			'title',
			[
				...
				'type' 			=> Controls_Manager::TEXT,
				'default'		=> __( 'Title of the Pricing Table', 'flatpro' ),
		...
		$this->add_control(
			'button_text',
			[
				'label' 		=> __( 'Button Text', 'flatpro' ),
				'type' 			=> Controls_Manager::TEXT,
				'default'		=> __( 'Click Here', 'flatpro' ),
				'placeholder' 	=> __( 'Title', 'flatpro' ),
				'label_block' 	=> true,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' 	=> __( 'Background Hover Color', 'flatpro' ),
				'type' 		=> Controls_Manager::COLOR,
				'default' 	=> '',
				'selectors' => [
		...
		$this->add_control(
			'feature_bg_color',
			[
				'label' 	=> __( 'Feature Background Color', 'flatpro' ),
				'type' 		=> Controls_Manager::COLOR,
				'scheme' 	=> [
					'type' 		=> Scheme_Color::get_type(),
					'value' 	=> Scheme_Color::COLOR_1,
		...
		$this->add_control(
			...
			[
				'label' 		=> __( 'Section Hover Color', 'flatpro' ),
		...
		$this->add_control(
			...
			[
				'label' 	=> __( 'Description Hover Color', 'flatpro' ),
				'type' 		=> Controls_Manager::COLOR,
				'scheme' 	=> [
					'type' 		=> Scheme_Color::get_type(),
					'value' 	=> Scheme_Color::COLOR_1,
		...
		$this->add_control(
			'price_hover_color',
			[
				'label' 	=> __( 'Price Hover Color', 'flatpro' ),
				'type' 		=> Controls_Manager::COLOR,
				'default' 	=> '',
				'selectors' => [
		...
		$this->add_responsive_control(
            'price_padding',
            [
                'label' 		=> __( 'Price Padding', 'flatpro' ),
                'type' 			=> Controls_Manager::DIMENSIONS,
                'size_units' 	=> [ 'px', 'em', '%' ],
                'selectors' 	=> [
		...
		$this->start_controls_section(
			...
			[
				'label' 	=> __( 'Duration Style', 'flatpro' ),
				'tab'   	=> Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			'duration_color',
			[
				'label' 	=> __( 'Duration Color', 'flatpro' ),
				'type' 		=> Controls_Manager::COLOR,
				'scheme' 	=> [
					'type' 		=> Scheme_Color::get_type(),
					'value' 	=> Scheme_Color::COLOR_1,
		...
		$this->add_control(
			...
			[
				'label' 	=> __( 'Duration Hover Color', 'flatpro' ),
				'type' 		=> Controls_Manager::COLOR,
				'default' 	=> '',
				'selectors' => [
		...
		$this->add_responsive_control(
            'duration_padding',
            [
                'label' 		=> __( 'Duration Padding', 'flatpro' ),
                'type' 			=> Controls_Manager::DIMENSIONS,
                'size_units' 	=> [ 'px', 'em', '%' ],
                'selectors' 	=> [
		...
		$this->add_control(
			'content_hover_color',
			[
				'label' 	=> __( 'Content Hover Color', 'flatpro' ),
				'type' 		=> Controls_Manager::COLOR,
				'default' 	=> '',
				'selectors' => [
