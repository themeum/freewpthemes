...
class Themeum_Widget_Posts_Grid_2 extends Widget_Base {
	...
	public function get_name() {
		return 'flatpro-posts-grid-2';
	}

	public function get_title() {
		return __( 'Themeum Posts Grid 2', 'flatpro' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .flatpro-post .grid-data-excerpt' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' 	=> '{{WRAPPER}} .flatpro-post .grid-data-excerpt',
			]
		);
		...
		<div class="row blog-grid-two">
			<?php if ( $data->have_posts() ) : ?>
				...
				<div class="blog-post-item-col col-<?php echo $post_column; ?>">
				    <article class="flatpro-post flatpro-single-post flatpro-index-post grid2">
				        ...
				        <?php } ?>
				        <div class="flatpro-blog-title grid2 clearfix">
				            ...
				            <div class="entry-blog">
				                <div class="entry-summary grid2 clearfix">
				                    ...
				                    <div class="grid-data-excerpt"><?php echo flatpro_excerpt_max_charlength( $textlimit ); ?>.....</div>
