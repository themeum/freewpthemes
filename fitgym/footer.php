...
?>
<?php
$footer_shortcode = get_theme_mod('themeum_footer_shortcode', '');
				...
				<?php if ( get_theme_mod( 'copyright_en', true )) { ?>
                    <div class="col-auto">
                        <div class="footer-copyright">
							<?php if( get_theme_mod( 'copyright_en', true ) ) { ?>
								<?php echo wp_kses_post(balanceTags( get_theme_mod( 'copyright_text', '&copy; 2018 Fitgym. All Rights Reserved.') )); ?>
							<?php } ?>
                        </div> <!-- col-md-6 -->
