...
class Fitgym_Theme_License{
	...
	public function license_page_asset_enquee(){
		wp_enqueue_style('plugin-license-handler', FITGYM_URI.'lib/license/license.css');
	}

	public function add_license_page(){
		global $submenu;
		add_submenu_page('fitgym-options','License', 'License', 'manage_options', 'fitgym-theme-license', array($this, 'license_form'));
		$submenu['fitgym-options'][] = array( 'Fitgym Docs', 'manage_options' , 'https://www.themeum.com/docs/fitgym-introduction/');
		$submenu['fitgym-options'][] = array( 'Fitgym Support Forum', 'manage_options' , 'https://www.themeum.com/forums/forum/fitgym/');
	}
	...
	public function check_license_key(){
		if ( ! empty($_POST['thm_check_license_code'])){
			...
			$key  = sanitize_text_field($_POST['fitgym_blog_license_key']);
				...
				<div class="themeum-box">
					...
					<form action="" method="post">
						...
						<p style="width: 100%; display: flex; flex-wrap: nowrap; box-sizing: border-box;">
							<input id="fitgym_blog_license_key" name="fitgym_blog_license_key" size="15" value="" class="regular-text code" style="flex-grow: 1; margin-right: 1rem;" type="text" placeholder="Enter your license key here" />
